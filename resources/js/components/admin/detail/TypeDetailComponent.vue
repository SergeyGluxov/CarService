        ...
        <div class="row">
            <div class="col-12">
                ...
                <form class="form-inline" method="GET" action="/admin/appointment/export">
                    <input type="text" v-model="vmTypeDetail" class="form-control" placeholder="Введите наименование "/>
                    <button id="show-modal" type="button" class="btn btn-success" v-on:click="storeTypeDetail()">
                        Добавить
                    </button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            storeTypeDetail: function () {
                var formData = new FormData();
                formData.append('title', this.vmTypeDetail);
                axios.post('/type/details', formData)
                    .then(response => {
            ...
            deleteUser: function (id) {
                axios.delete('/type/details/' + id).then((response) => {
                    this.update();
                    console.log(response.data);
                });
            },
